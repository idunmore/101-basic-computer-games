...
430 N=C(1+L):GOSUB 1940:PRINT "PITCHOUT"
440 N=C(2+L):GOSUB 1940:PRINT "TRIPLE REVERSE"
450 N=C(3+L):GOSUB 1940:PRINT "DRAW"
460 N=C(4+L):GOSUB 1940:PRINT "QB SNEAK"
470 N=C(5+L):GOSUB 1940:PRINT "END AROUND"
480 N=C(6+L):GOSUB 1940:PRINT "DOUBLE REVERSE"
490 N=C(7+L):GOSUB 1940:PRINT "LEFT SWEEP"
500 N=C(8+L):GOSUB 1940:PRINT "RIGHT SWEEP"
510 N=C(9+L):GOSUB 1940:PRINT "OFF TACKLE"
520 N=C(10+L):GOSUB 1940:PRINT "WISHBONE OPTION"
530 N=C(11+L):GOSUB 1940:PRINT "FLARE PASS"
540 N=C(12+L):GOSUB 1940:PRINT "SCREEN PASS"
550 N=C(13+L):GOSUB 1940:PRINT "ROLL OUT OPTION"
560 N=C(14+L):GOSUB 1940:PRINT "RIGHT CURL"
570 N=C(15+L):GOSUB 1940:PRINT "LEFT CURL"
580 N=C(16+L):GOSUB 1940:PRINT "WISHBONE OPTION"
590 N=C(17+L):GOSUB 1940:PRINT "SIDELINE PASS"
600 N=C(18+L):GOSUB 1940:PRINT "HALF-BACK OPTION"
610 N=C(19+L):GOSUB 1940:PRINT "RAZZLE DAZZLE"
620 N=C(20+L):GOSUB 1940:PRINT "BOMB!!!!!!!!"
630 L=L+20:T=2
...
898 C=8
900 IF C=8 THEN 904
901 GOSUB 1875:PRINT 10-(Y(T)*P-Y(T)*S);"YARDS TO 1ST DOWN"
902 GOTO 910
904 GOSUB 1875:PRINT X(T)-Y(T)*P;"YARDS TO GO"
910 GOSUB 1900:IF D=4 THEN 1180
920 REM *** RANDOM SEED STATEMENT OMITTED
930 U=INT(3*RND(1)-1):GOTO 940
...
1030 Y=0:GOTO 1050
1035 G=RND(1):IF G<.025 THEN 1040:IF Y>2 THEN 1045
...
1870 RETURN
1875 N=4
1880 IF ABS(P)<100 THEN N=N+1
1885 IF ABS(P)<10 THEN N=N+1
1890 FOR I=1 TO N:PRINT " ";:NEXT I
1895 RETURN
1900 N=INT(D(T)+4+P/2)
1902 FOR I=1 TO N:PRINT " ";:NEXT I
1904 PRINT M$(T)
