...
890 END
900 REM PRINT ONE STATUS LINE WITHOUT TAB
905 T$=STR$(T):H$=STR$(H):V$=STR$(V):F$=STR$(F)
910 PRINT T$;
912 I=LEN(T$)+1
913 IF I>3 THEN 920
915 FOR I=I TO 3:PRINT " ";:NEXT I
920 PRINT H$;
922 I=LEN(H$)+1
923 IF I>8 THEN 930
925 FOR I=I TO 8:PRINT " ";:NEXT I
930 PRINT V$;
932 I=LEN(V$)+1
933 IF I>8 THEN 940
935 FOR I=I TO 8:PRINT " ";:NEXT I
940 PRINT F$;
942 I=LEN(F$)+1
943 IF I>9 THEN 950
945 FOR I=I TO 9:PRINT " ";:NEXT I
950 PRINT "!";
955 P=INT(H/12)-1
960 IF P<1 THEN 975
965 FOR I=1 TO P:PRINT " ";:NEXT I
975 PRINT "*"
980 RETURN
999 END
