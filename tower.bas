...
1230 REM *** PRINT SUBROUTINE - NO TAB FUNCTION REQUIRED
1240 FOR K=1 TO 7
1250 FOR J=1 TO 3
1260 H=T(K,J)
1270 IF H<>0 THEN 1300
1280 H=1
1290 L=10:GOTO 1310
1300 L=INT((21-H)/2)
1310 FOR I=1 TO L:PRINT " ";:NEXT I
1320 FOR I=1 TO H:PRINT "*";:NEXT I
1330 FOR I=1 TO 21-L-H:PRINT " ";:NEXT I
1340 NEXT J
1350 PRINT
1360 NEXT K
1370 RETURN
