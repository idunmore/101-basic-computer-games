...
266 LET T8=INT(4.99*RND(1)+1)
267 REM RANDOMIZE SIGN OF FIRST TREND SLOPE
268 IF RND(1)>.5 THEN 270
269 LET A=-A
...
845 LET I1=INT(4.99*RND(1)+1)
846 LET N1=INT(4.99*RND(1)+1)
847 LET E1=1
850 REM IF N2 DAYS PASSED, PICK I2, SET E2, AND SET NEW N2
851 IF N2>0 THEN 860
855 LET I2=INT(4.99*RND(1)+1)
856 LET N2=INT(4.99*RND(1)+1)
857 LET E2=1
...
955 LET C(I)=INT(A*S(I))+X1+INT(3-6*RND(1)+.5)+W3
...
990 LET T8=INT(4.99*RND(1)+1)
992 LET A=INT((RND(1)/10)*100+.5)/100
993 LET S4=RND(1)
