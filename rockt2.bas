...
400 PRINT "                                 !"
405 PRINT "                                 0"
410 PRINT "                      << DIRECTION OF ORBIT <<"
415 PRINT
420 PRINT "                          SURFACE OF MOON"
425 PRINT
430 PRINT
...
1210 GOTO 1165
1215 END
1220 T$=STR$(T):H$=STR$(H):D$=STR$(D)
1225 V$=STR$(H1):W$=STR$(D1):F$=STR$(T2)
1230 PRINT T$;
1235 J=9-LEN(T$):IF J<1 THEN 1250
1240 FOR I=1 TO J:PRINT " ";:NEXT I
1250 PRINT H$;
1255 J=13-LEN(H$):IF J<1 THEN 1270
1260 FOR I=1 TO J:PRINT " ";:NEXT I
1270 PRINT D$;
1275 J=14-LEN(D$):IF J<1 THEN 1290
1280 FOR I=1 TO J:PRINT " ";:NEXT I
1290 PRINT V$;
1295 J=12-LEN(V$):IF J<1 THEN 1310
1300 FOR I=1 TO J:PRINT " ";:NEXT I
1310 PRINT W$;
1315 J=11-LEN(W$):IF J<1 THEN 1330
1320 FOR I=1 TO J:PRINT " ";:NEXT I
1330 PRINT F$
1340 RETURN
