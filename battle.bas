...
230 M=2
240 Z=B(1)
242 IF B(2)>=Z THEN 246
244 Z=B(2)
246 IF B(3)>=Z THEN 250
248 Z=B(3)
250 IF Z=1 THEN 90
...
450 M=2
460 Z1=A(1)
462 IF A(2)<=Z1 THEN 466
464 Z1=A(2)
466 IF A(3)<=Z1 THEN 470
468 Z1=A(3)
470 Z2=B(1)
472 IF B(2)<=Z2 THEN 476
474 Z2=B(2)
476 IF B(3)<=Z2 THEN 480
478 Z2=B(3)
...
630 M=2
640 Z=A(1)
642 IF A(2)>=Z THEN 646
644 Z=A(2)
646 IF A(3)>=Z THEN 650
648 Z=A(3)
650 IF Z=1 THEN 90
...
860 M=2
870 Z1=A(1)
872 IF A(2)>=Z1 THEN 876
874 Z1=A(2)
876 IF A(3)>=Z1 THEN 880
878 Z1=A(3)
880 Z2=B(1)
882 IF B(2)<=Z2 THEN 886
884 Z2=B(2)
886 IF B(3)<=Z2 THEN 890
888 Z2=B(3)
