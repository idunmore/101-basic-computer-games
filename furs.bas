...
1177 LET D1=INT((.2*RND(1)+.80)*10^2+.5)/10^2
...
1206 LET E1=INT((.15*RND(1)+.80)*10^2+.5)/10^2
1207 LET B1=INT((.2*RND(1)+.90)*10^2+.5)/10^2
...
1261 LET E1=INT((.15*RND(1)+.95)*10^2+.5)/10^2
1262 LET B1=INT((.25*RND(1)+1.00)*10^2+.5)/10^2
1263 LET D1=INT((.25*RND(1)+1.10)*10^2+.5)/10^2
